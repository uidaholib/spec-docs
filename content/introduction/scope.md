...
The **University Collection** (UG) consists of items generated by the University of Idaho or generated using university resources. These records are true university archival materials (see the end of this page for examples). Particularly strong components of the University Collection include:
...
The **Manuscript Collection** (MG) consists of those materials that are not directly connected to U of I, or materials that have a university connection but were not generated by the university itself (such as faculty papers). Spec has traditionally focused on Idaho history related to:
- Mining
- Forestry
- Industry
- Settlement
...
Some collections are very small (i.e., one item in one folder). Small MGs should be smaller than a quarter-size box. When those are processed, they are given a Small Manuscript Group 4-digit identifier starting with **5** and are shelved in the Small MG storage area. 
...
| Kolln book collection | *forthcoming |
