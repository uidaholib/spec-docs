...
| General | Optional | Include other information regarding the collection or the processing procedures. **If the collection contains offensive content**, include a General note and fill in the language under [Standard Language>Resource Records](https://uidaholib.github.io/spec-docs/content/practices-procedures/offensive-material.html#resource-records) in the Offensive Material Practices section.| 
