...
| General | Optional | Include other information regarding the collection or the processing procedures. **If the collection contains offensive content**, include a General note with the label Other Descriptive Information and fill in the language under [Resource Record procedure](https://uidaholib.github.io/spec-docs/content/practices-procedures/offensive-material.html#resource-record-procedure) in the Offensive Material Practices section.| 
