...
nav_order: 3
title: Rehousing and Arrangement
---
...
Arrangement information was taken in part from the [Arizona State University Processing Manual, March 2015](https://www2.archivists.org/sites/all/files/asu_processing_manual.pdf). 
...
- Material type (photographs, papers, audiovisual materials, etc.)
See Creating Series and Subseries below for more information.
...
- Function
    ...
    - Research papers
    - Legal papers
It is common for a collection to include both format- and function-based series.
...
1. Foldering
    ...
    - Do not over-fill folders. If materials cannot fit within a single folder folded along the largest score line, put materials in multiple folders. Use the same folder title, but add numbers (e.g., "1 of 2").
    -The folder title should go in the upper left corner of the folder tab.
2. Staples and Clips:
...
See [Photo Negatives and Prints]({{ '/content/practices-procedures/negatives-prints.html' | relative_url }}) for more information about deteriorating photographic materials. If negatives are cracking, warping, or emitting a vinegar smell, discuss with colleagues. Some materials can be placed in cold storage to slow deterioration. Other might need to be digitized and disposed of. 
