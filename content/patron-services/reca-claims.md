...
<div class="text-center mb-2">
    <a href="#{{ 'RECA Form for Patrons' | slugify }}" class="btn btn-secondary my-2 mx-1">RECA Form for Patrons</a>
...
### RECA Form for Patrons

#### Links to Form

- Spec form that RECA patrons should fill out: [Request for Assistance with RECA Claim](https://forms.office.com/Pages/ResponsePage.aspx?id=Y2u8fpJXGUqyCwS4JgSIUxaSEHQ0MBFJmCa2EIVFmhNURUQ4RjZZMFEzVjVRSjNFOEhNSTRKNk9ITC4u)
    - Simple URL: [https://go.uidaho.edu/reca](https://go.uidaho.edu/reca)
...
- RECA form response spreadsheet: [RECA Requests](https://vandalsuidaho.sharepoint.com/:x:/r/sites/Storage-Library/Documents/spec/Reference/Downwinders/RECA%20Requests.xlsx?d=wdb63c796c08741578c7d7767a24d8cee&csf=1&web=1&e=bWjebs)
...
In July 2025, the federal government expanded the Radiation Exposure Compensation Act (RECA) to provide financial compensation to individuals who lived anywhere in Idaho between 1951 and 1962 and subsequently developed certain kinds of illnesses. Claimants, also called "Downwinders", may qualify for compensation if they can establish that they were diagnosed with a relevant illness and lived in Idaho between 1951 and 1962. 

The University of Idaho Special Collections and Archives (Spec) holds a collection of telephone and city directories: [IDTELE](https://archiveswest.orbiscascade.org/ark:80444/xv238803). The residency information in these directories can be helpful evidence that a Downwinder patron lived in Idaho in the 1951-1962 period. Spec can provide certified copies (inclusion of a cover letter signed by the department head).  

#### What We Need From Patrons

Patrons should supply the following via the [Request for Assistance with RECA Claim](https://forms.office.com/Pages/ResponsePage.aspx?id=Y2u8fpJXGUqyCwS4JgSIUxaSEHQ0MBFJmCa2EIVFmhNURUQ4RjZZMFEzVjVRSjNFOEhNSTRKNk9ITC4u) (or Spec employees can fill in the spreadsheet directly):

- Claimant name, email address and/or phone number
- Name(s) of person whose residency is in question, including maiden names, other names they were known by, parents' names (if they were a minor)
...
| Published by telephone companies | Published by directory companies |
| Includes anyone with phone service; excludes people who did not have telephone service | Information often collected by door-to-door surveys and postal route information |
| May include name, address, and phone number | May include name, spouse's name, address, phone number, occupation, employer (varies widely). For rural residents, may include just name and rural mail delivery route number ("Rural Route") |
...
- Telephone and city directories often have multiple sections of listings that encompass nearby towns and rural areas. If you can't find the person you're looking for in the town provided by the patron, try looking in other sections of the same directory.  
- A city directory may have multiple rural routes listed, so be sure to look through each rural route. 
- If you can't find the person you're looking for, check for other family members they might have lived with (Ancestry.com can be helpful in establishing connections). 
- Married women are often listed under their husband's name, but they are frequently not listed at all (especially in phone books). You might see something like "Smith, John (Mary)" or "Smith, John (Mrs. John Smith)".  
- People with very common names (John Smith, George Johnson, etc.) might require additional identifying information to confirm.
- People might appear with different spellings (directory publishers can make mistakes!), nicknames, or initials only. 
